...
gam1 <- gam(Load ~ s(as.numeric(Date),
  k = 3,
  bs = "cr"
) + s(toy, k = 30, bs = "cc") + s(Temp, k = 10, bs = "cr"), data = Data0)
summary(gam1)
plot(gam1)
...
rmse.old.forecast <- c(
  rmse1.forecast, rmse2.forecast, rmse3.forecast, rmse4.forecast, rmse5.forecast, rmse6.forecast,
