...
mape<-function(y,ychap)  # moyenne de lerreur absolue relative => en % d'erreur, 
  #soumise aux caractéristique des données (y doit pas etre proche de 0) pas adapté pr prod° solaire car tombe à 0 la nuit
{
