...
On transforme WeekDays en facteurs
```{r}
...
# Convert WeekDays from numeric to factor with appropriate labels
X_train$WeekDays <- factor(X_train$WeekDays, levels = 0:6, labels = c("Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"))
head(X_train[, c("Date", "WeekDays")])
tail(X_train[, c("Date", "WeekDays")])
```
```{r}
